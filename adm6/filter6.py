...
class Ip6_Filter_Rule(UserDict):
    ...
    def produce_Debian(self, outfile, commented):
        ...
        #rule_id = u' -m comment --comment "' + self['RuleText'] + u'"'
...
'''
        ...
        #        dif = ""# -o "+ str(self['source-if'])
        #    print ipi + sif + line1
        #    outfile.write(ipi + sif + line1 + u'\n')
        #    if answer_packets:
        #        print ipo + dif + line2
        #        outfile.write(ipo + dif + line2 + u'\n')
        #if self['travers']:
        #    sif = ""
        #    dif = ""
        #    if not self['noif']:
        ...
        #        return
        #    print ipf + dif + line1
        #    outfile.write(ipf + sif + line1 + u'\n')
        #    if answer_packets:
        #        print "# ", ipf + sif + line2
        #        outfile.write(ipf + dif + line2 + u'\n')
        ########################################################################
